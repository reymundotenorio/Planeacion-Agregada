...
public class FuerzaNPOJO {
    ...
    private String Hrs_E;
    private String Hrs_O;
    private String Cost_OS;
    private String Cost_mant;
    private String Cost_normal;
    private String Cost_extra;
    private String Cost_total;

    public FuerzaNPOJO() {
    }

    public FuerzaNPOJO(String Semana, String Prod_req, String Hrs_req, String Hrs_disp, String Hrs_disp_N, String Unids_prod, String Unids_falt, String Unids_sobr, String Hrs_E, String Hrs_O, String Cost_OS, String Cost_mant, String Cost_normal, String Cost_extra, String Cost_total) {
        this.Semana = Semana;
    ...
    public String getHrs_E() {
        return Hrs_E;
    }

    public void setHrs_E(String Hrs_E) {
        this.Hrs_E = Hrs_E;
    }

    public String getHrs_O() {
        return Hrs_O;
    }

    public void setHrs_O(String Hrs_O) {
        this.Hrs_O = Hrs_O;
    }
    ...
    public String getCost_extra() {
        return Cost_extra;
    }

    public void setCost_extra(String Cost_extra) {
        this.Cost_extra = Cost_extra;
    }
